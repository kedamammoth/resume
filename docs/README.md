...
| 資格     | 普通自動車免許、溶接管理技術者（JWES）2 級、ITパスポート |
...
| 技術       | 経験 | 説明                                                                       |
| ---------- | ---- | -------------------------------------------------------------------------- |
| TypeScript | 2 年 | 型定義を活用した安全性の意識したコーディングができます                     |
| Angular    | 2 年 | Angular Material を用いたコンポーネント設計・実装が可能です                |
...
| Git        | 5 年 | ブランチ運用やマージ、リベースなどの Git コマンドを問題なく扱えます        |
| HTML       | 5 年 | セマンティックなマークアップとヘッド要素の適切な管理が得意です             |
| CSS        | 5 年 | アニメーションやレスポンシブ対応を含む動きのあるデザイン実装ができます     |
| JavaScript | 4 年 | DOM 操作や非同期処理などを駆使した豊富なインタラクティブ機能を実装できます |
...
| 2024.6 ～ 2026 現在 | 株式会社 truss システム開発<br>［担当］フロントエンドエンジニア<br>・新規機能開発、改善、運用・保守（TypeScript/Angular）<br>・リファクタリング<br>・Jest ＋ Testing Library によるテストコード実装<br>・開発環境改善（フレームワーク・ライブラリのバージョンアップなど）<br>・現機能のUI/UX改善の提案から実装の                                                                                                                                                                                                                                                                                             |
